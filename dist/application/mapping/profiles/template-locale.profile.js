...
let TemplateLocaleProfile = class TemplateLocaleProfile extends nestjs_1.AutomapperProfile {
    ...
    get profile() {
        return (mapper) => {
            (0, core_1.createMap)(mapper, create_template_locale_dto_1.CreateTemplateLocaleDto, template_locale_entity_1.TemplateLocale);
            (0, core_1.createMap)(mapper, template_locale_entity_1.TemplateLocale, read_template_locale_dto_1.ReadTemplateLocaleDto);
            (0, core_1.createMap)(mapper, create_template_dto_1.CreateTemplateDto, template_locale_entity_1.TemplateLocale, (0, core_1.forMember)((dst) => dst.locale, (0, core_1.mapWithArguments)((_, { locale }) => locale)));
            (0, core_1.createMap)(mapper, patch_template_dto_1.PatchTemplateDto, template_locale_entity_1.TemplateLocale, (0, core_1.forMember)((dst) => dst.locale, (0, core_1.mapWithArguments)((_, { locale }) => locale)));
        };
    }
};
